...
#else
  #define CASADI_PREFIX(ID) kuka_kr_120_fk_ ## ID
#endif
...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a16=(a11*a26);
  a16=(a16-a25);
  if (res[5]!=0) res[5][10]=a16;
  if (res[5]!=0) res[5][11]=a4;
  a13=1.9500000000000001e-01;
  a9=(a13*a9);
  a12=-5.8999999999999997e-02;
  a21=(a12*a21);
  a9=(a9+a21);
  a1=(a1+a9);
  ...
  a12=(a12-a3);
  a13=(a13+a12);
  if (res[6]!=0) res[6][2]=a13;
  if (res[6]!=0) res[6][3]=a4;
  a13=4.8965831389580217e-12;
  a12=(a13*a14);
  a12=(a12-a2);
  if (res[6]!=0) res[6][4]=a12;
  a12=(a13*a10);
  a12=(a12-a18);
  if (res[6]!=0) res[6][5]=a12;
  a12=(a13*a23);
  a12=(a12-a16);
  if (res[6]!=0) res[6][6]=a12;
