...
#else
  #define CASADI_PREFIX(ID) kuka_kr_120_sat_fk_ ## ID
#endif
...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a2=cos(a1);
  a3=(a0*a2);
  a4=-6.5359958625396203e-07;
  a1=sin(a1);
  a5=(a4*a1);
  a3=(a3+a5);
  if (res[0]!=0) res[0][0]=a3;
  a5=(a4*a2);
  a6=-9.9999999999978639e-01;
  a7=(a6*a1);
  a5=(a5+a7);
  if (res[0]!=0) res[0][1]=a5;
  a7=9.7931777202934950e-12;
  a8=(a7*a1);
  ...
  a2=-6.4008169060953476e-18;
  if (res[0]!=0) res[0][8]=a2;
  a4=-9.7931777202914028e-12;
  ...
  a11=-3.1342487454659208e-29;
  a11=(a11-a10);
  if (res[1]!=0) res[1][8]=a11;
  a10=-4.7953652532567706e-23;
  a10=(a10-a6);
  ...
  a3=(a7*a3);
  a12=2.6204944413554351e-18;
  a3=(a3+a12);
  if (res[1]!=0) res[1][12]=a3;
  a5=(a7*a5);
  a12=4.0093269586873005e-12;
  a5=(a5+a12);
  if (res[1]!=0) res[1][13]=a5;
  a7=(a7*a8);
  a8=4.0939999999999999e-01;
  a7=(a7+a8);
  a1=(a1+a7);
  ...
  a19=(a14*a21);
  a19=(a16+a19);
  if (res[4]!=0) res[4][8]=a19;
  a24=(a14*a7);
  a24=(a13+a24);
  if (res[4]!=0) res[4][9]=a24;
  a25=(a14*a23);
  a25=(a17+a25);
  if (res[4]!=0) res[4][10]=a25;
  if (res[4]!=0) res[4][11]=a9;
  a4=5.8999999999999997e-02;
  a16=(a4*a16);
  a2=-3.4150000000000003e-01;
  a21=(a2*a21);
  a16=(a16+a21);
  a3=(a3+a16);
  if (res[4]!=0) res[4][12]=a3;
  a13=(a4*a13);
  a7=(a2*a7);
  a13=(a13+a7);
  a5=(a5+a13);
  ...
  a13=(a13+a7);
  a17=(a17+a13);
  if (res[5]!=0) res[5][0]=a17;
  a13=(a15*a23);
  a7=(a22*a4);
  a16=(a24*a2);
  a7=(a7+a16);
  a13=(a13+a7);
  if (res[5]!=0) res[5][1]=a13;
  a23=(a26*a23);
  a7=(a8*a4);
  a16=(a25*a2);
  a7=(a7+a16);
  ...
  if (res[5]!=0) res[5][11]=a9;
  a2=1.9500000000000001e-01;
  a6=(a2*a6);
  ...
  a16=(a25*a8);
  a2=(a2+a16);
  if (res[6]!=0) res[6][2]=a2;
  if (res[6]!=0) res[6][3]=a9;
  a2=(a25*a17);
  a16=5.1032511549919946e-12;
  a26=(a16*a20);
  a15=-1.0206823934513927e-11;
  a24=(a15*a7);
  a26=(a26+a24);
  a2=(a2+a26);
  if (res[6]!=0) res[6][4]=a2;
  a2=(a25*a13);
  a26=(a16*a22);
  a24=(a15*a4);
  a26=(a26+a24);
  a2=(a2+a26);
  if (res[6]!=0) res[6][5]=a2;
  a25=(a25*a23);
  a16=(a16*a8);
  a2=(a15*a14);
  a16=(a16+a2);
  a25=(a25+a16);
  if (res[6]!=0) res[6][6]=a25;
  if (res[6]!=0) res[6][7]=a9;
  a17=(a15*a17);
  ...
  if (res[6]!=0) res[6][11]=a9;
  a9=-2.0000000000000000e-02;
  a7=(a9*a7);
  a3=(a3+a7);
  if (res[6]!=0) res[6][12]=a3;
  a4=(a9*a4);
  a5=(a5+a4);
