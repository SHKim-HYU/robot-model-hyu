...
#else
  #define CASADI_PREFIX(ID) hyu_spa_dJ_s_ ## ID
#endif
...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a1=1.5669999999999999e+00;
  a2=arg[1]? arg[1][0] : 0;
  a3=(a1*a2);
  a4=-1.5669999999999999e+00;
  a4=(a4*a2);
  a3=(a3+a4);
  a3=(-a3);
