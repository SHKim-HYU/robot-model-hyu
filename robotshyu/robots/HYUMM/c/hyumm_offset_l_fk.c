...
#else
  #define CASADI_PREFIX(ID) hyumm_offset_l_fk_ ## ID
#endif
...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a5=(a7*a5);
  a5=(a5-a18);
  if (res[4]!=0) res[4][10]=a5;
  if (res[4]!=0) res[4][11]=a2;
  a8=-2.6700000000000002e-01;
  a16=(a8*a16);
