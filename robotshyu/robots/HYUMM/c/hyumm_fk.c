...
#else
  #define CASADI_PREFIX(ID) hyumm_fk_ ## ID
#endif
...
/* fk_T:(q[9])->(T_base_link[4x4],T_joint0[4x4],T_joint1[4x4],T_joint2[4x4],T_joint3[4x4],T_joint4[4x4],T_joint5[4x4],T_indy7_tcp[4x4]) */
