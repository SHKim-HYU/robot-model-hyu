...
/* fk_T:(q[6])->(T_joint0[4x4],T_joint1[4x4],T_joint2[4x4],T_joint3[4x4],T_joint4[4x4],T_joint5[4x4],T_ft_fixed[4x4],T_tcp_CoM_fixed[4x4]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a8=(a19*a21);
  a22=(a22-a8);
  if (res[5]!=0) res[5][4]=a22;
  a8=(a11*a7);
  a18=(a17*a12);
  a8=(a8-a18);
  a18=(a16*a21);
  a8=(a8-a18);
  if (res[5]!=0) res[5][5]=a8;
  a7=(a13*a7);
  a12=(a23*a12);
  a7=(a7-a12);
  a21=(a9*a21);
  ...
  a26=(a5*a23);
  a24=(a24+a26);
  if (res[5]!=0) res[5][10]=a24;
  if (res[5]!=0) res[5][11]=a2;
  a26=3.3507970647335344e-01;
  a27=(a26*a19);
  a28=2.9988499999999940e-01;
  a29=(a28*a25);
  a27=(a27+a29);
  a27=(a6+a27);
  if (res[5]!=0) res[5][12]=a27;
  a29=(a26*a16);
  a30=(a28*a17);
  a29=(a29+a30);
  a29=(a15+a29);
  if (res[5]!=0) res[5][13]=a29;
  a26=(a26*a9);
  a28=(a28*a23);
  a26=(a26+a28);
  a26=(a1+a26);
  if (res[5]!=0) res[5][14]=a26;
  if (res[5]!=0) res[5][15]=a3;
  a28=(a5*a19);
  a30=(a20*a25);
  a28=(a28+a30);
  if (res[6]!=0) res[6][0]=a28;
  a28=(a5*a16);
  a30=(a20*a17);
  a28=(a28+a30);
  ...
  a11=(a5*a25);
  a13=(a13+a11);
  if (res[6]!=0) res[6][8]=a13;
  a13=(a21*a16);
  a11=(a5*a17);
  a13=(a13+a11);
  if (res[6]!=0) res[6][9]=a13;
  a21=(a21*a9);
  a5=(a5*a23);
  a21=(a21+a5);
  if (res[6]!=0) res[6][10]=a21;
  if (res[6]!=0) res[6][11]=a2;
  a21=1.7356596866755541e-01;
  a19=(a21*a19);
  a5=2.0663499999999979e-01;
  a25=(a5*a25);
  a19=(a19+a25);
  a6=(a6+a19);
  if (res[6]!=0) res[6][12]=a6;
  a16=(a21*a16);
  a17=(a5*a17);
  a16=(a16+a17);
  a15=(a15+a16);
  if (res[6]!=0) res[6][13]=a15;
  a21=(a21*a9);
  a5=(a5*a23);
  a21=(a21+a5);
  a1=(a1+a21);
  ...
  if (res[7]!=0) res[7][1]=a14;
  if (res[7]!=0) res[7][2]=a10;
  if (res[7]!=0) res[7][3]=a2;
  if (res[7]!=0) res[7][4]=a22;
  if (res[7]!=0) res[7][5]=a8;
  if (res[7]!=0) res[7][6]=a7;
  if (res[7]!=0) res[7][7]=a2;
  if (res[7]!=0) res[7][8]=a12;
  if (res[7]!=0) res[7][9]=a18;
  if (res[7]!=0) res[7][10]=a24;
  if (res[7]!=0) res[7][11]=a2;
  a2=-1.1660000000000000e-05;
  a0=(a2*a0);
  a1=-9.3200000000000006e-06;
  a22=(a1*a22);
  a21=-4.6730979999999998e-02;
  a12=(a21*a12);
  a22=(a22+a12);
  a0=(a0+a22);
  a27=(a27+a0);
  if (res[7]!=0) res[7][12]=a27;
  a14=(a2*a14);
  a8=(a1*a8);
  a18=(a21*a18);
  a8=(a8+a18);
