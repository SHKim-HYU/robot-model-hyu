...
#else
  #define CASADI_PREFIX(ID) yl012_sat_fk_ ## ID
#endif
...
/* fk_T:(q[6])->(T_joint0[4x4],T_joint1[4x4],T_joint2[4x4],T_joint3[4x4],T_joint4[4x4],T_joint5[4x4],T_sat_fixed[4x4]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a5=8.2589999999999997e-02;
  a19=(a5*a19);
  a22=1.5411000000000000e-01;
  a25=(a22*a25);
  a19=(a19+a25);
  a6=(a6+a19);
  if (res[5]!=0) res[5][12]=a6;
  a16=(a5*a16);
  a17=(a22*a17);
  a16=(a16+a17);
  a15=(a15+a16);
  ...
  if (res[6]!=0) res[6][8]=a20;
  if (res[6]!=0) res[6][9]=a7;
  if (res[6]!=0) res[6][10]=a21;
  if (res[6]!=0) res[6][11]=a2;
  a2=7.3849999999999999e-02;
  a20=(a2*a20);
  a6=(a6+a20);
